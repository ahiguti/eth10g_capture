...
write_cfgmem -force -format mcs -size 128 -interface SPIx8 -loadbit "up 0x00000000 $bit_filename" -file "$proj_dir/$proj_name.mcs"
current_hw_device [get_hw_devices xcku115_0]
refresh_hw_device [lindex [get_hw_devices xcku115_0] 0]
create_hw_cfgmem -hw_device [lindex [get_hw_devices] 0] -mem_dev [lindex [get_cfgmem_parts {mt25qu512-spi-x1_x2_x4_x8}] 0]
set_property PROGRAM.ADDRESS_RANGE  {entire_device} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku115_0] 0]]
set_property PROGRAM.FILES [list $proj_dir/${proj_name}_primary.mcs $proj_dir/${proj_name}_secondary.mcs] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku115_0] 0]]
set_property PROGRAM.PRM_FILE {} [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xcku115_0] 0]]
